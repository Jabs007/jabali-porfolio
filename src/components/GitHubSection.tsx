  ...
  return (
    <MotionSection id="github" className="py-24">
      <div className="section-container relative">
        ...
        <h2 className="text-3xl sm:text-4xl font-black mb-2 flex items-center gap-4">
        ...
        <div className="space-y-12">
          ...
          {/* GitHub Streak - Keep the dynamic image since it's most unique, but add a wrapper */}
